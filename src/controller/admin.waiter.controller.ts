...
export class AdminwaiterController {
  ...
  // @Post('/loginadminwaiter')
  // async loginadmin (@Body() body:{email:string,password:string} ): Promise<any> {
  //   const admin: ADMINwaiter | null = await new  MainAdminWaiter().loginadmin(body);
  //   return <SaveUpdateResADMINwaiter>admin;
  // }
